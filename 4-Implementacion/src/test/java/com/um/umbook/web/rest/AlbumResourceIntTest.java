...
public class AlbumResourceIntTest {
     ...
     *
     * @see com.um.umbook.repository.search.AlbumSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final AlbumResource albumResource = new AlbumResource(albumRepository, mockAlbumSearchRepository);
    ...
    public void searchAlbum() throws Exception {
        // Initialize the database
        albumRepository.saveAndFlush(album);
        when(mockAlbumSearchRepository.search(queryStringQuery("id:" + album.getId())))
