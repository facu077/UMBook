...
import { IFoto, Foto } from 'app/shared/model/foto.model';
...
describe('Service Tests', () => {
    describe('Foto Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Foto(0, 'image/png', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Foto', async () => {
                const returnedFromService = Object.assign(
                    {
                        imagen: 'BBBBBB'
                    },
